...
bool passw = true;
int melody1[] = {262, 294, 330, 349, 392, 330, 262};
int melody2[] = {392, 440, 494, 523, 494, 440, 392};
int melody3[] = {523, 659, 784, 659, 698, 880, 784};
int noteIndex = 0;
  ...
  if (playing)
{
  ...
  if (currentMillis - previousMillis >= 350)
  {
    ...
    {
      tone(11, currentMelody[noteIndex]);
      noteIndex++;
    }
    else
    {
  ...
  if (digitalRead(10) == LOW && exitVal == false && value == SYSTEMNUM)
  {
      value = SYSTEM;
      exitVal = true;
      lcd.clear();
...
else if (key == '3' && value == MUSIC)
{
  ...
  playing = true;
    ...
    else if (digitalRead(10) == LOW && (value == MUSIC1 || value == MUSIC2 || value == MUSIC3))
    {
      exitVal = true;
      playing = false;
      noTone(11);
    ...
    else if (key == '1' && value == SYSTEM)
    {
      ...
      lcd.print("About");
      lcd1.setCursor(0,0);
      lcd1.print("Version 1.0.0");
    }
    else if (key == '2' && value == SYSTEM)
    {
      value = SYSTEMNUM;
      exitVal = false;
      lcd.clear();
      ...
      lcd.print("Hardware");
      lcd1.setCursor(0,0);
      lcd1.print("Lcd Now: 4");
      lcd2.setCursor(0,0);
      lcd2.print("Keypad: OK");
      lcd3.setCursor(0,0);
      lcd3.print("Buzzer: OK");
    }
    else if (key == '3' && value == SYSTEM)
    {
      value = SYSTEMNUM;
      exitVal = false;
      lcd.clear();
